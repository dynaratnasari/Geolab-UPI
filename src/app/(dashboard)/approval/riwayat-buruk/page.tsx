...
import { KONDISI_LABEL, GOOD_RETURN_CONDITIONS } from "@/lib/constants/peminjaman";
...
export default async function RiwayatKondisiBurukPage() {
  ...
  const returns = await prisma.returnRecord.findMany({
    ...
    include: {
      loan: { include: { mahasiswa: true, items: { include: { item: true, unit: true } } } },
    },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-bold tracking-tight text-foreground">Riwayat Kondisi Buruk</h1>
